...
const Achivement = () => {
    return (
        <div className="bg-[#1E4FFD] font-Space_Grotesk px-5 md:px-12 lg:px-0">
            <div className="max-w-[930px] mx-auto md:flex py-[50px] gap-[151px]">
                <div className="flex-1">
                    ...
                    <a href="#contact"><button style={{boxShadow: "0px 8px 22px 0px rgba(20, 77, 138, 0.30)"}} className="text-[#1E4FFD] font-bold bg-white px-[30px] py-[18px] rounded-full mb-12 md:mb-0">Get connected now!</button></a>
                </div>
                <div>
