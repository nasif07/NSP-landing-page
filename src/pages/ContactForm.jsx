...
const ContactForm = () => {
    ...
    return (
        <section id="contact" className="md:pt-12 px-4 md:px-10 lg:px-0">
            <div style={{ border: "1px solid #1E4FFD" }} className=" max-w-[1120px] mx-auto font-Space_Grotesk rounded-2xl py-[50px] md:py-[100px] px-2 md:px-8 lg:px-[50px] mb-[150px]">
